...
public class MediumGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Medium", "Hard", "Easy" }));
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        switch (selectedDifficulty) {
            case "Easy" -> {
                // Open the EasyGame JFrame
                EasyGame easyGame = new EasyGame();
                easyGame.setVisible(true);
                this.setVisible(false); // Hide the current frame (MediumGame)
            }
        ...
        // Stay in the current Medium game
